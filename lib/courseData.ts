...
| 因素 | 权重 | 来源 |
|------|------|------|
| 波动率 | 25% | BTC 30/90天波动率 |
| 市场动量 | 25% | 价格 vs 30/90天均值 |
| 社交媒体 | 15% | Twitter/Reddit情绪 |
| 调查 | 15% | 投资者问卷 |
| BTC主导率 | 10% | BTC vs 山寨币市值占比 |
| Google趋势 | 10% | "Bitcoin"搜索量 |
...
1. 你打开行情时的第一反应是什么？（兴奋/焦虑/无感/恐惧）
2. Fear & Greed Index 当前值
3. 你看到的新闻标题（偏乐观还是偏恐慌？）

**坚持1个月后你会发现：**
- 你的情绪和市场情绪经常同步 → 你就是那个"散户指标"
- 当你学会识别自己的情绪，就能用反向思维对抗它
- 极度恐惧时你不敢买 = 正好说明应该买

> "当你恐惧到不敢买时，问自己：这个恐惧是因为基本面恶化，还是因为价格下跌？如果是后者，你的恐惧就是买入信号。"`,
        quiz: [
          {
...
**正常回撤**：回到突破位±3%以内
**过度回撤**：跌回突破位以下太多 → 可能是假突破，放弃

### Step 3：确认（Confirmation）
价格在突破位附近获得支撑（做多）或阻力（做空）。

**确认信号**：
- 在突破位形成看涨/看跌K线形态（锤子线、吞没等）
- 成交量在回撤时缩小，确认时放大
- RSI未进入超卖/超买（还有空间）
- 下级时间框架出现趋势反转

### Step 4：延续（Continuation）
确认后价格继续原方向运动。这是你开始盈利的阶段。
...
### 为什么止损这么宽？
- Retest经常有"假跌破"——价格短暂跌破支撑又拉回
- 太紧的止损会被反复打掉
- 宽止损 + 小仓位 = 给交易呼吸空间

### 目标位
- 最低目标：前一波推动的100%（1:1）
- 理想目标：前一波推动的161.8%（斐波那契）
- 可以分批止盈：50%在1:1，剩余追踪止损
...
### 1. 追突破不等Retest
- "万一不回来怎么办？" → 那就放过这笔，等下一笔
- 没有Retest的突破 = 你无法设置有效止损
...
> "最好的Retest往往发生在最无聊的时候——大多数人已经失去耐心，但价格正在安静地确认支撑。"

> "不是每个突破都有Retest。大约50-60%会有。错过了就错过了——永远有下一笔。"

> "Retest交易的核心优势：止损明确、入场逻辑清晰、不需要预测方向。"`,
        quiz: [
          {
