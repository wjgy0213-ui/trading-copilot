...
function TradeTable({ trades }: { trades: BacktestResult['trades'] }) {
  ...
  return (
    <div>
      <button onClick={() => setShow(!show)} className="flex items-center gap-2 rounded text-sm text-gray-400 hover:text-gray-200 transition mb-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400">
      ...
      <div className="flex flex-col items-center gap-4 max-w-sm w-full" onClick={e => e.stopPropagation()}>
        ...
        <div className="flex gap-3 w-full">
          <button onClick={handleCopy}
            className="flex-1 flex items-center justify-center gap-2 bg-gray-800 hover:bg-gray-700 text-gray-200 py-2.5 rounded-xl text-sm font-medium transition-all border border-gray-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-400">
            {copied ? <><Check className="w-4 h-4 text-emerald-400" />{tr('strategy.copied')}</> : <><Copy className="w-4 h-4" />{tr('strategy.copyShare')}</>}
          </button>
          <button onClick={onClose}
            className="px-4 flex items-center justify-center bg-gray-800 hover:bg-gray-700 text-gray-400 rounded-xl border border-gray-700 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-400">
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="max-w-[1400px] mx-auto px-4 py-6">
        <div className="flex items-center justify-between mb-6">
          ...
          {results.length > 0 && <button onClick={() => setResults([])} className="rounded text-xs text-gray-500 hover:text-gray-300 flex items-center gap-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400"><Trash2 className="w-3 h-3" /> {tr('strategy.clearButton')}</button>}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            {STRATEGY_TEMPLATES.map(t => (
              <button key={t.id} onClick={() => handleSelect(t.id)}
                className={`w-full text-left p-3 rounded-xl border transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 ${selectedId === t.id ? 'border-emerald-500/50 bg-emerald-500/10' : 'border-gray-800 bg-gray-900/30 hover:border-gray-700'}`}>
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <button onClick={() => setShowCode(!showCode)} className="flex items-center gap-2 rounded text-xs text-gray-500 hover:text-gray-300 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400">
            ...
            <button onClick={handleRun} disabled={loading}
              className={`w-full py-3 rounded-xl font-medium text-sm flex items-center justify-center gap-2 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-950 ${loading ? 'bg-gray-800 text-gray-500 cursor-wait' : 'bg-emerald-600 hover:bg-emerald-500 text-white'}`}>
            ...
            <button onClick={handleOptimize} disabled={optimizing || loading}
              className={`w-full py-3 rounded-xl font-medium text-sm flex items-center justify-center gap-2 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-400 focus-visible:ring-offset-2 focus-visible:ring-offset-gray-950 ${optimizing ? 'bg-gray-800 text-gray-500 cursor-wait' : 'bg-violet-600 hover:bg-violet-500 text-white'}`}>
                      ...
                      <tr key={i} className="border-b border-gray-800/50 hover:bg-violet-500/5">
                        ...
                        <td className="py-1.5 px-2 text-right">
                          <button onClick={() => { setParams(o.params); setOptResults([]); }}
                            className="rounded text-[10px] text-violet-400 hover:text-violet-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-400">{tr('strategy.apply')}</button>
                        </td>
                      </tr>
                    ))}</tbody>
                  </table>
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex items-center gap-1.5 text-xs text-emerald-400 hover:text-emerald-300 bg-emerald-500/10 hover:bg-emerald-500/20 px-3 py-1.5 rounded-lg transition-all border border-emerald-500/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400">
                      <Rocket className="w-3.5 h-3.5" /> {tr('strategy.deployPaper')}
                    </button>
                    <button onClick={() => setShowShareCard(true)}
                      className="flex items-center gap-1.5 text-xs text-violet-400 hover:text-violet-300 bg-violet-500/10 hover:bg-violet-500/20 px-3 py-1.5 rounded-lg transition-all border border-violet-500/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-400">
              ...
              <div className="bg-gray-900/30 border border-emerald-800/40 rounded-xl p-4 space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <button onClick={() => {
                    ...
                    className={`text-xs px-3 py-1.5 rounded-lg font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 ${mcRunning ? 'bg-gray-800 text-gray-500 cursor-wait' : 'bg-emerald-700 hover:bg-emerald-600 text-white'}`}>
